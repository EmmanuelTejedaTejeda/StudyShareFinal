 ...
 * Use the {@link I_Industrial#newInstance} factory method to
 * create an instance of this fragment.
 */
public class I_Industrial extends Fragment {
    RecyclerView industrial;
     ...
     * @return A new instance of fragment I_Industrial.
     */
    // TODO: Rename and change types and number of parameters
    public static I_Industrial newInstance(String param1, String param2) {
        I_Industrial fragment = new I_Industrial();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Inflar la vista
        View view = inflater.inflate(R.layout.fragment_i__industrial, container, false);
            ...
            public void onClick(View v) {
                ...
                scaledow.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        Navigation.findNavController(view).navigate(R.id.action_i_Industrial_to_inicio);
                    }
                });
                scaledow.start();
            }
        ...
        industrial = view.findViewById(R.id.Rindustrial);
        industrial.setLayoutManager(new LinearLayoutManager(getActivity()));
        ...
        industrial.setAdapter(mainAdapter);
        return view;
    }
