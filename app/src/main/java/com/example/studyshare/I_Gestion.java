 ...
 * Use the {@link I_Gestion#newInstance} factory method to
 * create an instance of this fragment.
 */
public class I_Gestion extends Fragment {
    RecyclerView gestion;
     ...
     * @return A new instance of fragment I_Gestion.
     */
    // TODO: Rename and change types and number of parameters
    public static I_Gestion newInstance(String param1, String param2) {
        I_Gestion fragment = new I_Gestion();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_i__gestion, container, false);
            ...
            public void onClick(View v) {
                ...
                scaledow.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        Navigation.findNavController(view).navigate(R.id.action_i_Gestion_to_inicio);
                    }
                });
                scaledow.start();
            }
        ...
        gestion = view.findViewById(R.id.Rgestion);
        gestion.setLayoutManager(new LinearLayoutManager(getActivity()));
        ...
        gestion.setAdapter(mainAdapter);
        return view;
    }
