 ...
 * Use the {@link I_Sistemas#newInstance} factory method to
 * create an instance of this fragment.
 */
public class I_Sistemas extends Fragment {
    RecyclerView sistemas;
     ...
     * @return A new instance of fragment I_Sistemas.
     */
    // TODO: Rename and change types and number of parameters
    public static I_Sistemas newInstance(String param1, String param2) {
        I_Sistemas fragment = new I_Sistemas();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View  view = inflater.inflate(R.layout.fragment_i__sistemas, container, false);
            ...
            public void onClick(View v) {
                ...
                scaledow.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        Navigation.findNavController(view).navigate(R.id.action_i_Sistemas_to_inicio);
                    }
                });
                scaledow.start();
            }
        });
        sistemas = view.findViewById(R.id.Rsistemas);
        sistemas.setLayoutManager(new LinearLayoutManager(getActivity()));
        ...
        sistemas.setAdapter(mainAdapter);
        return view;
    }
