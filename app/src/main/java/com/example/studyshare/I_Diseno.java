 ...
 * Use the {@link I_Diseno#newInstance} factory method to
 * create an instance of this fragment.
 */
public class I_Diseno extends Fragment {
    RecyclerView diseno;
     ...
     * @return A new instance of fragment I_Diseno.
     */
    // TODO: Rename and change types and number of parameters
    public static I_Diseno newInstance(String param1, String param2) {
        I_Diseno fragment = new I_Diseno();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_i__diseno, container, false);
            ...
            public void onClick(View v) {
                ...
                scaledow.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        Navigation.findNavController(view).navigate(R.id.action_i_Diseno_to_inicio);
                    }
                });
                scaledow.start();
            }
        ...
        diseno = view.findViewById(R.id.Rdiseno);
        diseno.setLayoutManager(new LinearLayoutManager(getActivity()));
