...
public class I_Mecatronica extends Fragment {
     ...
     * @return A new instance of fragment I_Mecatronica.
     */
    // TODO: Rename and change types and number of parameters
    public static I_Mecatronica newInstance(String param1, String param2) {
        I_Mecatronica fragment = new I_Mecatronica();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View  view = inflater.inflate(R.layout.fragment_i__mecatronica, container, false);
            ...
            public void onClick(View v) {
                ...
                scaledow.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        Navigation.findNavController(view).navigate(R.id.action_i_Mecatronica_to_inicio);
                    }
                });
                scaledow.start();
            }
