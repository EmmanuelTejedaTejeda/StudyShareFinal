...
public class I_Informatica extends Fragment {
     ...
     * @return A new instance of fragment I_Informatica.
     */
    // TODO: Rename and change types and number of parameters
    public static I_Informatica newInstance(String param1, String param2) {
        I_Informatica fragment = new I_Informatica();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_i__informatica, container, false);
            ...
            public void onClick(View v) {
                ...
                scaledow.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        Navigation.findNavController(view).navigate(R.id.action_i_Informatica_to_inicio);
                    }
                });
                scaledow.start();
            }
